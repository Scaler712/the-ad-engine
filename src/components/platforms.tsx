  ...
  return (
    <section className="pb-10">
      <div className="mx-auto max-w-3xl px-6">
        <p className="text-center text-[10px] text-muted-foreground/50 uppercase tracking-[0.2em] mb-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12">
          {platforms.map((p, i) => (
            <motion.div
              ...
              className="text-muted-foreground/25 hover:text-navy transition-colors duration-300"
              title={p.name}
            >
              <p.logo className="h-5 md:h-6 w-auto" />
            </motion.div>
          ))}
        </div>
      </div>
